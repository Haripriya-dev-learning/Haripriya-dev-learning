...
Connection
con=DriverManager.getConnection("jdbc:mysql://localhost:3306/blockchain_auditor","root
","root");
...
if(rs.next())
{
out.println("<html><body><script>alert('PAN ID already exists
!');</script></body></html>");
...
empreg(NAME,EMAIL,PASSWORD,PANID)values('"+n+"','"+e+"','"+pa+"','"+p+"')");
